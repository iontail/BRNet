...
# 2025/March revise the code applying update of pytorch
def nms(boxes, scores, overlap=0.5, top_k=200):
    ...
    xx1 = torch.zeros_like(x1)
    yy1 = torch.zeros_like(y1)
    xx2 = torch.zeros_like(x2)
    yy2 = torch.zeros_like(y2)
    w = torch.zeros_like(x1)
    h = torch.zeros_like(y1)
